							...
							<div class="m-stack__item m-brand m-stack__item--left">
								<div class="m-stack m-stack--ver m-stack--general m-stack--inline">
									<div class="m-stack__item m-stack__item--middle m-brand__logo">
										<a href="<?php echo $link ?>" class="m-brand__logo-wrapper">
								...
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
											<a  href="customer.php" class="m-menu__link m-menu__toggle">
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true">
											<a  href="customertransfer.php" class="m-menu__link m-menu__toggle">
												<span class="m-menu__link-text">
													Transfer
												</span>
												<i class="m-menu__hor-arrow la la-angle-down"></i>
		...
		<!-- begin::Body -->
			<div class="m-grid__item m-grid__item--fluid  m-grid m-grid--ver-desktop m-grid--desktop m-page__container m-body">
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<a class="btn btn-primary btn-sm" href="editProfile.php" style="float:right;"> <i class="fa fa-fw fa-edit"></i> Edit</a>
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<img src="assets/app/media/img//users/user4.jpg" alt=""/> 
								<span style="font-size:45px; height:100px; margin:auto;font-weight:bold;font-color:grey;padding-left:20px;margin-top:40px">
									Lee User
								</span>
					...
					<div class="m-content">
						...
						<table class="table" style="border:none;" id="dataTable" width="100%" cellspacing="0">
						  <tbody>
						  <tr><td colspan=2 style="color:grey" ><h2>User Info</h2></td></td></tr>
						  <tr><td>NRIC:</td><td>S9123456Z</td></tr>
						<tr><td>Contact:</td><td>92325911</td></tr>
						
						<tr><td colspan=2 style="color:grey" ><h2>Accounts</h2></td></td></tr>
						  <tr><td>Account Number:</td><td>123456</td></tr>
							<tr><td>Balance:</td><td>$1000</td></tr>
							<tr><td colspan=2 style="color:grey" ><h2>Occupation</h2></td></td></tr>
							<tr><td>Occupation:</td><td>-</td></tr>
				<tr><td>Job Title:</td><td>-</td></tr>
				<tr><td colspan=2 style="color:grey" ><h2>Address</h2></td></td></tr>
				<tr><td>Address:</td><td>Tampines st99 blk 999 #09-999</td></tr>
				<tr><td>Postal Code:</td><td>520999</td></tr>
