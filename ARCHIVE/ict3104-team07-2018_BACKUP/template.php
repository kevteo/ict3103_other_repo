...
<html lang="en" >
	...
	<!-- end::Head -->
    <!-- end::Body -->
	<body  style="background-image: url(assets/app/media/img/bg/bg-8.jpg)"  class="m-page--fluid m-page--loading-enabled m-page--loading m-header--fixed m-header--fixed-mobile m-footer--push m-aside--offcanvas-default"  >
		<!-- begin::Page loader -->
