...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2018 at 04:09 PM
...
-- Database: `mbank`
--
CREATE DATABASE IF NOT EXISTS `mbank` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mbank`;
...
(482, '5.00', 1, NULL, '2018-11-03 15-50-45', 'deposit'),
(483, '0.00', 1, NULL, '2018-11-03 15-51-29', 'withdraw'),
(484, '-5.00', 1, NULL, '2018-11-03 15-51-31', 'withdraw'),
(485, '0.00', 1, NULL, '2018-11-03 15-51-44', 'withdraw'),
(486, '2.00', 1, 0, '2018-11-03 16-05-51', 'transfer'),
(487, '0.50', 1, NULL, '2018-11-03 16-05-51', 'charge'),
(488, '4.00', 1, 0, '2018-11-03 16-06-11', 'transfer'),
(489, '0.50', 1, NULL, '2018-11-03 16-06-11', 'charge'),
(490, '4.00', 1, 0, '2018-11-03 16-06-35', 'transfer'),
(491, '0.50', 1, NULL, '2018-11-03 16-06-35', 'charge'),
(492, '5.00', 1, 0, '2018-11-03 16-07-40', 'transfer');
...
(1, 'customer1', '123', 'customer', 'customer1', 's9999901c', '97832323', 'kevin9001@live.com', 'Tampines st 91, Blk999 #09-999, Singapore 520999', '024-61263-1', 'below 2000', '1045.00', 2, 1, 0, '2018-11-02 06-12-01', 0, 313510, 1, '1200.00', '1045.00'),
(2, 'customer2', '123', 'customer', 'customer2', 's9999902c', '97832323', 'leexd1994@gmail.com', 'Jurong st 91, Blk929 #09-929, Singapore 500929', '024-65463-2', '2000-3000', '505.00', 2, 1, 0, '2018-11-02 01-20-36', 0, 0, 2, '0.00', '0.00'),
...
(8, 'manager1', '123', 'manager', 'manager1', 's9999908c', '97832323', 'kevin9001@live.com', 'Orchard st 32, Blk32 #02-32, Singapore 520132', NULL, NULL, '50.00', 2, 1, 0, '2018-11-02 01-32-02', 0, 992216, 2, '0.00', '0.00'),
...
--
ALTER TABLE `transaction`
  MODIFY `transactionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=493;
--
